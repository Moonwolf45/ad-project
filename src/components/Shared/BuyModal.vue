    ...
    <v-card>
      <v-container>
        <v-layout row>
          <v-flex xs12>
            <v-card-title>
              <h1 class="text--primary">Do you wan`t to buy id?</h1>
            </v-card-title>
          </v-flex>
        </v-layout>
        <v-divider/>
        <v-layout row>
          <v-flex xs12>
            <v-card-text>
              ...
              <v-text-field name="phone" label="Your phone" type="tel" v-model="phone"/>
            </v-card-text>
          </v-flex>
        </v-layout>
        <v-divider/>
        <v-layout row>
          <v-flex xs12>
            <v-card-actions>
              ...
              <v-btn class="success" flat @click="onSave" :disabled="localLoading" :loading="localLoading">Buy it!</v-btn>
            </v-card-actions>
          </v-flex>
        </v-layout>
      </v-container>
